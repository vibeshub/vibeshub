...
REQUIRED="VIBESHUB_DATABASE_URL VIBESHUB_AZURE_BLOB_CONTAINER VIBESHUB_AZURE_STORAGE_ACCOUNT_URL AZURE_CLIENT_ID VIBESHUB_PUBLIC_BASE_URL VIBESHUB_SESSION_SECRET VIBESHUB_TOKEN_ENCRYPTION_KEY"
missing=""
